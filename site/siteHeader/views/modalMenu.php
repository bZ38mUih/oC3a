...
$appRJ->response['result'].= "<div class='modal menu'>";
...
if(isset($_SESSION['groups']['root']) and $_SESSION['groups']['root']>10) {
    ...
    $appRJ->response['result'].= "<img src='/admin/img/admin_logo.jpg'>";
    $appRJ->response['result'].= "</div>";
    $appRJ->response['result'].= "<div class='modal-line-text'>";
    $appRJ->response['result'].= "<a href='/admin/'>Admin</a>";
    $appRJ->response['result'].= "</div>";
    $appRJ->response['result'].= "</div>";
}
...
if($_SESSION['user_id']){
    ...
    $appRJ->response['result'].= "</div>";
    $appRJ->response['result'].= "<div class='modal-line-text'>";
    $appRJ->response['result'].= "<a href='/personal-page'>Личный кабинет</a>";
    $appRJ->response['result'].= "<a href='?cmd=exit' class='exit'>Exit</a>";
    if($ntf_cnt>0){
    ...
    $appRJ->response['result'].= "<img src='/data/avatar-default.jpg'>";
    $appRJ->response['result'].= "</div>";
    $appRJ->response['result'].= "<div class='modal-line-text guest'>";
    $appRJ->response['result'].= "<a href='#' style='cursor: default'>Вы: Гость.".
...
if(isset($_SESSION['groups']['1']) and $_SESSION['groups']['1']>=10) {
    $appRJ->response['result'].= "<div class='modal-line'>";
    $appRJ->response['result'].= "<div class='modal-line-img'>";
    $appRJ->response['result'].= "<img src='/site/personal-page/img/logo.jpg'>";
    $appRJ->response['result'].= "</div>";
    $appRJ->response['result'].= "<div class='modal-line-text'>";
    $appRJ->response['result'].= "<a href='/personal-page/ppManager/' class='sub-lnk blue'>ЛК-Менеджер</a>";
    $appRJ->response['result'].= "</div>";
    $appRJ->response['result'].= "</div>";
}
/*<--ppManager*/
...
if ($appRJ->server['reqUri_expl'][1] != null) {
    $appRJ->response['result'].= "<div class='modal-line'>";
    $appRJ->response['result'].= "<div class='modal-line-img'>";
    $appRJ->response['result'].= "<img src='/site/landing/img/favicon-64.png'>";
    $appRJ->response['result'].= "</div>";
    $appRJ->response['result'].= "<div class='modal-line-text'>";
    $appRJ->response['result'].= "<a href='/'>Главная</a>";
    $appRJ->response['result'].= "</div>";
    $appRJ->response['result'].= "</div>";
}
/*<--landing*/
...
/*artMan-->*/
if(isset($_SESSION['groups']['1']) and $_SESSION['groups']['1']>=10) {
    //if ($appRJ->server['reqUri_expl'][1] != 'artMan') {
    $appRJ->response['result'].= "<div class='modal-line'>";
    $appRJ->response['result'].= "<div class='modal-line-img'>";
    $appRJ->response['result'].= "<img src='/site/artMan/img/logo.png'>";
    $appRJ->response['result'].= "</div>";
    $appRJ->response['result'].= "<div class='modal-line-text'>";
    $appRJ->response['result'].= "<a href='/artMan/' class='sub-lnk blue'>artMan</a>";
    $appRJ->response['result'].= "</div>";
    $appRJ->response['result'].= "</div>";
    //}
}
...
$appRJ->response['result'].= "<div class='modal-line'>";
$appRJ->response['result'].= "<div class='modal-line-img'>";
$appRJ->response['result'].= "<img src='/site/dev/img/logo.png'>";
$appRJ->response['result'].= "</div>";
$dwlSign = "+";
...
$appRJ->response['result'].= "<ul " . $dwlStyle . ">";
...
$appRJ->response['result'].= "<div class='modal-line'>";
$appRJ->response['result'].= "<div class='modal-line-img'>";
$appRJ->response['result'].= "<img src='/site/pc/img/logo.png'>";
$appRJ->response['result'].= "</div>";
$dwlSign = "+";
$dwlStyle = "style='display: none'";
$appRJ->response['result'].= "<div class='modal-line-text'>";
...
$appRJ->response['result'].= "<div class='modal-line'>";
$appRJ->response['result'].= "<div class='modal-line-img'>";
$appRJ->response['result'].= "<img src='/site/gallery/img/logo.png'>";
$appRJ->response['result'].= "</div>";
$dwlSign = "+";
$dwlStyle = "style='display: none'";
$appRJ->response['result'].= "<div class='modal-line-text'>";
...
$appRJ->response['result'].= "<li><a href='" . "/gallery/albums/" . "' class='sub-lnk ";
if ($appRJ->server['reqUri_expl'][2] == 'albums') {
    $appRJ->response['result'].= "active";
}
$appRJ->response['result'].= "'>" . "Альбомы" . "</a></li>";
$appRJ->response['result'].= "<li><a href='/gallery/category/' class='sub-lnk ";
...
if($appRJ->server['reqUri_expl'][1]!='signIn'){
    $appRJ->response['result'].= "<div class='modal-line'>";
    $appRJ->response['result'].= "<div class='modal-line-img'>";
    $appRJ->response['result'].= "<img src='/site/signIn/img/logo.png'>";
    $appRJ->response['result'].= "</div>";
    $appRJ->response['result'].= "<div class='modal-line-text'>";
    $appRJ->response['result'].= "<a href='/signIn'>Вход на сайт</a>";
    $appRJ->response['result'].= "</div>";
    $appRJ->response['result'].= "</div>";
}
