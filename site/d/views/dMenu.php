...
if(isset($_SESSION['groups']['1']) and $_SESSION['groups']['1']>=10){
    ...
    /*
    $appRJ->response['result'].= "<div class='modal-line'><div class='modal-line-img'>".
        "<img src='/site/d/img/quarter-menu.png' alt='d-logo'></div>";
    $dwlSign = "+";
    $dwlStyle = "style='display: none'";
    $appRJ->response['result'].= "<div class='modal-line-text'>";
    if ($diary_rd->result['diaryType'] == "quarterly" or strtolower($appRJ->server['reqUri_expl'][2])=="quarterly") {
        $dwlSign = "-";
        $dwlStyle = null;
    }
    $appRJ->response['result'].= "<a href='/d/quarterly' title='Quarterly'>Quarterly</a> <span class='opnSubMenu'>" . $dwlSign .
        "</span> ". "<ul " . $dwlStyle . ">";

    $appRJ->response['result'].= "<li><a href='/d/newDiary?diaryType=quarterly";
    $appRJ->response['result'].="' class='sub-lnk light ";
    if ($appRJ->server['reqUri_expl'][2] == "newDiary" and
        ($diary_rd->result['diaryType'] == "quarterly" or strtolower($appRJ->server['reqUri_expl'][2])=="quarterly")) {
        $appRJ->response['result'].= "active";
    }
    $appRJ->response['result'].= "' title='look up'>newDiary</a></li>";

    $appRJ->response['result'].= "<li><a href='/d/quarterly/lastNote";
    $appRJ->response['result'].="' class='sub-lnk light ";
    if ($appRJ->server['reqUri_expl'][3] == "lastNote") {
        $appRJ->response['result'].= "active";
    }
    $appRJ->response['result'].= "' title='look up'>lastNote</a></li>";
    ...
    $appRJ->response['result'].= "<div class='modal-line'><div class='modal-line-img'>".
        "<img src='/site/d/img/year-menu.png' alt='d-logo'></div>";
    $dwlSign = "+";
    $dwlStyle = "style='display: none'";
    $appRJ->response['result'].= "<div class='modal-line-text'>";
    if ($diary_rd->result['diaryType'] == "yearly" or strtolower($appRJ->server['reqUri_expl'][2])=="yearly") {
        $dwlSign = "-";
        $dwlStyle = null;
    }
    $appRJ->response['result'].= "<a href='/d/yearly' title='Yearly'>Yearly</a> <span class='opnSubMenu'>" . $dwlSign .
        "</span> ". "<ul " . $dwlStyle . ">";

    $appRJ->response['result'].= "<li><a href='/d/newDiary?diaryType=yearly";
    $appRJ->response['result'].="' class='sub-lnk light ";
    if ($appRJ->server['reqUri_expl'][2] == "newDiary") {
        $appRJ->response['result'].= "active";
    }
    $appRJ->response['result'].= "' title='look up'>newDiary</a></li>";

    $appRJ->response['result'].= "<li><a href='/d/yearly/lastNote";
    $appRJ->response['result'].="' class='sub-lnk light ";
    if ($appRJ->server['reqUri_expl'][3] == "lastNote") {
        $appRJ->response['result'].= "active";
    }
    ...
    $appRJ->response['result'].= "<div class='modal-line'><div class='modal-line-img'>".
        "<img src='/site/d/img/conception-menu.png' alt='d-logo'></div>";
    $dwlSign = "+";
    $dwlStyle = "style='display: none'";
    $appRJ->response['result'].= "<div class='modal-line-text'>";
    if ($diary_rd->result['diaryType'] == "conception" or strtolower($appRJ->server['reqUri_expl'][2])=="conception") {
        $dwlSign = "-";
        $dwlStyle = null;
    }
    $appRJ->response['result'].= "<a href='/d/conception' title='Conception'>Conception</a> <span class='opnSubMenu'>" . $dwlSign .
        "</span> ". "<ul " . $dwlStyle . ">";

    $appRJ->response['result'].= "<li><a href='/d/newDiary?diaryType=conception";
    $appRJ->response['result'].="' class='sub-lnk light ";
    if ($appRJ->server['reqUri_expl'][2] == "newDiary") {
        $appRJ->response['result'].= "active";
    }
    ...
    $appRJ->response['result'].= "<li><a href='/d/conception/lastNote";
    $appRJ->response['result'].="' class='sub-lnk light ";
    if ($appRJ->server['reqUri_expl'][3] == "lastNote") {
        $appRJ->response['result'].= "active";
    }
    ...
    */
    //
    //if (strtolower($appRJ->server['reqUri_expl'][2]) == "quarterly") {
    /*
        $dwlSign = "-";
        $dwlStyle = null;
        ...
        $appRJ->response['result'].= "<li><a href='/d/quarterly/newNote";
        $appRJ->response['result'].="' class='sub-lnk light ";
        $appRJ->response['result'].= "' title='look up'>newNote</a></li>";
...
*/
    ...
    //}
    /*
    if (strtolower($appRJ->server['reqUri_expl'][2]) == "yearly") {
        $dwlSign = "-";
        $dwlStyle = null;
        ...
        $appRJ->response['result'].= "<li><a href='/d/yearly/newNote";
        $appRJ->response['result'].="' class='sub-lnk light ";
        $appRJ->response['result'].= "' title='look up'>newNote</a></li>";
    ...
    if (strtolower($appRJ->server['reqUri_expl'][2]) == "daily") {
        $dwlSign = "-";
        $dwlStyle = null;

        $appRJ->response['result'].= "<a href='/d/daily' title='Daily'>Daily</a> <span class='opnSubMenu'>" . $dwlSign .
            "</span> ". "<ul " . $dwlStyle . ">";

        $appRJ->response['result'].= "<li><a href='/d/daily/newNote";
        $appRJ->response['result'].="' class='sub-lnk light ";
        $appRJ->response['result'].= "' title='look up'>newNote</a></li>";

        $appRJ->response['result'].= "<li><a href='/d/daily/lastNote";
        $appRJ->response['result'].="' class='sub-lnk light ";
        $appRJ->response['result'].= "' title='look up'>lastNote</a></li>";
