...
<div class='sFrame'>
<div id='jssor_1' style='position:relative;margin:0 auto;top:0px;left:0px;width:1366px;height:465px;overflow:hidden;visibility:hidden;'>
        <!-- Loading Screen -->
        <div data-u='loading' class='jssorl-009-spin' style='position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);'>
            <img style='margin-top:-19px;position:relative;top:50%;width:38px;height:38px;' src='img/spin.svg' />
        </div>
        <div data-u='slides' style='cursor:default;position:relative;top:0px;left:0px;width:1366px;height:465px;overflow:hidden;'>
            <div>
                <img data-u='image' src='/site/services/img/rightJoint.png' />
            </div>
            <div>
                <img data-u='image' src='/site/services/img/developing.png' />
            </div>
            <div>
                <img data-u='image' src='/site/services/img/seo.png' />
            </div>
            <div>
                <img data-u='image' src='/site/services/img/coding.png' />
            </div>
            <div>
                <img data-u='image' src='/site/services/img/supporting.png' />
            </div>
