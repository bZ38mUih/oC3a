...
$appRJ->response['result'].= "<meta name='description' content='Управление категориями' http-equiv='Content-Type' charset='charset=utf-8'>";
$appRJ->response['result'].= "<meta name='robots' content='noindex'>";
$appRJ->response['result'].= "<title>Управление услугами</title>";
$appRJ->response['result'].= "<link rel='SHORTCUT ICON' href='/site/services/img/favicon.png' type='image/png'>";
