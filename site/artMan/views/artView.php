...
$appRJ->response['result'].= "<meta name='description' content='".$artByAlias_row['artMeta']."' ".
    "http-equiv='Content-Type' charset='charset=utf-8'>";
$appRJ->response['result'].= "<title>".$artByAlias_row['catName']."</title>";
$appRJ->response['result'].= "<link rel='SHORTCUT ICON' href='/site/".$artByAlias_row['catAlias']."/img/favicon.png' type='image/png'>";
...
$appRJ->response['result'].="<img src='".ARTS_IMG_PAPH.$artByAlias_row['art_id']."/preview/".$artByAlias_row['artImg']."' id='shareImg'>";
$appRJ->response['result'].= "</div>";
$appRJ->response['result'].="<div class='art-header-descr'>";
$appRJ->response['result'].="<h2>".$artByAlias_row['artMeta']."</h2>";
$appRJ->response['result'].= "</div>";
