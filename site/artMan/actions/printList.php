    ...
    if($catCount>0 or $artCount>0){
        ...
        if($artCount>0){
            while ($slArt_row=$DB->doFetchRow($slArt_res)){
                $tmpItm=null;
                $tmpItm.="<li class='itm-line'>";
                $tmpItm.= "<a href='/".$ref."/".$slArt_row['artAlias']."'>";
                $tmpItm.= "<div class='itm-line-img'>";
                if($slArt_row['artImg']){
                ...
                $tmpItm.= "</div>";
                $tmpItm.= "<div class='itm-line-txt'>";
                $tmpItm.= "<div class='itm-line-name'>";
                $tmpItm.= $slArt_row['artName'];
                $tmpItm.= "</div>";
                $tmpItm.= "<div class='itm-line-descr'>";
        ...
        if($catCount>0){
            while ($selectCat_row=$DB->doFetchRow($selectCat_res)){
                ...
                $tmpCat.= "<a href='/".$ref."/".$selectCat_row['catAlias']."'>";
