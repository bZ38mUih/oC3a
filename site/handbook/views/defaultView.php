...
$appRJ->response['result'].= "<meta name='description' content='Систематизированная информация о компьютерных технологиях' http-equiv='Content-Type' charset='charset=utf-8'>";
$appRJ->response['result'].= "<title>Справочник</title>";
$appRJ->response['result'].= "<link rel='SHORTCUT ICON' href='/site/handbook/img/favicon.png' type='image/png'>";
