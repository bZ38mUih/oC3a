...
$appRJ->response['result'].= "<meta name='description' content='Правка категории' http-equiv='Content-Type' charset='charset=utf-8'>";
...
$appRJ->response['result'].= "<input type='text' name='glCat_id' value='".$Cat_rd->result['glCat_id']."' disabled>";
$appRJ->response['result'].= "</div>";
$appRJ->response['result'].= "<div class='input-line'>";
...
$appRJ->response['result'].= "</div>";
$appRJ->response['result'].= "<div class='input-line'>";
$appRJ->response['result'].= "<label for='glCat_parId'>glCat_parId:</label>";

$appRJ->response['result'].= "<select name='glCat_parId'>";
