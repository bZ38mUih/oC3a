...
$appRJ->response['result'].= "<meta name='description' content='Выгрузка альбомов на сайт' http-equiv='Content-Type' charset='charset=utf-8'>";
...
$appRJ->response['result'].= "<script type='text/javascript' src='/site/gallery/js/uploadFolder.js'></script>";
...
$appRJ->response['result'].= "<label for='targetFolder'>Target folder: </label>";
$appRJ->response['result'].= "<input type='text' id='targetFolder' value=''>";
$appRJ->response['result'].= "<input type='button' value='start' onclick='uploadAlbums()'>";
$appRJ->response['result'].= "</form>";

$appRJ->response['result'].= "<form class='uploadAlb-res'>";
$appRJ->response['result'].= "</form>";
