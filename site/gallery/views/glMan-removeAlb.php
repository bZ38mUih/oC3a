...
$appRJ->response['result'].= "<meta name='description' content='Удалить альбом навсегда' http-equiv='Content-Type' charset='charset=utf-8'>";
...
$appRJ->response['result'].= "<link rel='stylesheet' href='/site/gallery/css/delAlb-form.css' type='text/css' media='screen, projection'/>";
...
$appRJ->response['result'].= "<script type='text/javascript' src='/site/gallery/js/delAlb.js'></script>";
