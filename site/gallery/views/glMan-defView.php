...
$appRJ->response['result'].= "<meta name='description' content='Создание/редактирование альбомов/категорий' http-equiv='Content-Type' charset='charset=utf-8'>";
...
require_once ($_SERVER["DOCUMENT_ROOT"]."/site/gallery/views/glMan-categories.php");
