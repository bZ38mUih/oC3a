...
$appRJ->response['result'].= "<div class='remove-photo'>";
$appRJ->response['result'].= "<div class='rm-cnt'>Кол-во фотографий: <span>".$photo_row['photoCnt']."</span></div>";
$appRJ->response['result'].= "<div class='rm-act'>";
...
$appRJ->response['result'].= "<div class='remove-like'>";
$appRJ->response['result'].= "<div class='rm-cnt'>Кол-во лайков: <span>".$like_row['likeCnt']."</span></div>";
$appRJ->response['result'].= "<div class='rm-act'>";
if($like_row['likeCnt']>0){
