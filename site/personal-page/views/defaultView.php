...
$appRJ->response['result'].= "<meta name='description' content='Личный кабинет' http-equiv='Content-Type' charset='charset=utf-8'>";
...
$appRJ->response['result'].= "<link rel='stylesheet' href='/site/personal-page/css/ntfList.css' type='text/css' media='screen, projection'/>";
