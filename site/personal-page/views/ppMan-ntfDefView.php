...
$appRJ->response['result'] .= "<meta name='description' content='Настройки оповещений' http-equiv='Content-Type' charset='charset=utf-8'>";
...
$appRJ->response['result'].="<br>bla-bla<br>";
...
//$appRJ->response['result'].= $appRJ->response['result'];