...
$appRJ->response['result'].= "<meta name='description' content='Пользователи сайта. Список пользователей.' http-equiv='Content-Type' charset='charset=utf-8'>";
...
$appRJ->response['result'].= "<link rel='stylesheet' href='/site/personal-page/css/ppMan-usrList.css' type='text/css' media='screen, projection'/>";
$appRJ->response['result'].= "</head>";
...
require_once ($_SERVER["DOCUMENT_ROOT"]."/site/personal-page/actions/ppMan-users.php");
