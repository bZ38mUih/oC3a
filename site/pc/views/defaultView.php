...
$appRJ->response['result'].= "<meta name='description' content='Статьи по ремонту компьютеров и компьютерным технологиям.
Список статей и категорий' http-equiv='Content-Type' charset='charset=utf-8'>";
$appRJ->response['result'].= "<title>Компьютеры и технологии</title>";
$appRJ->response['result'].= "<link rel='SHORTCUT ICON' href='/site/pc/img/favicon.png' type='image/png'>";
...
$prtLst= printList(1, $DB, $appRJ->server['reqUri_expl'][1]);
